...
void print_token(unsigned char token[2], estado_filosofo estado) { // APARTADO 0.2
 ...
 char* estado2str(int estado) { //APARTADO 0.2 // APARTADO 1
  switch (estado) {
    ...
    case 5: return "queriendo_condimentar";
    case 6: return "condimentando";
    case 7: return "dejando_condimentar";
    case 8: return "hablando";
