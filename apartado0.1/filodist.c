...
void procesaLineaComandos(int numero, char *lista[])
{
  ...
  else
  {
    ...
    {
      fprintf(stderr, "El id del filosofo debe ser un numero entero\n"); // APARTADO 0.1
    ...
    {
      fprintf(stderr, "El numero de filosofos debe ser un numero entero\n"); // APARTADO 0.1
    ...
    {
      fprintf(stderr, "La IP siguiente debe ser una IP valida\n"); // APARTADO 0.1
    ...
    {
      fprintf(stderr, "El puerto siguiente debe ser un numero entero\n"); // APARTADO 0.1
    ...
    {
      fprintf(stderr, "El puerto local debe ser un numero entero\n"); // APARTADO 0.1
    ...
    {
      fprintf(stderr, "El delay debe ser un numero entero\n"); // APARTADO 0.1
